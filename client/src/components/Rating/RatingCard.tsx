...
const RatingCard: React.FC<RatingCardProps> = ({ rating }) => {
  ...
  <p className="font-bold">
    ...
    <span className="font-thin ml-2 break-words">{rating.user.name}</span>
  </p>

  <p className="font-bold">
    <span className="whitespace-nowrap">Rating:</span>
    <span className="font-thin ml-2">{rating.value}</span>
  </p>

  <p className="font-bold">
    <span className="whitespace-nowrap">Store Name:</span>
    <span className="font-thin ml-2 break-words">{rating.store.name}</span>
  </p>
</div>
