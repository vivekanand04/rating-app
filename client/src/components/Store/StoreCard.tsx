...
export const StoreCard: React.FC<StoreCardProps> = ({
  ...
  return (
    <div className="flex flex-col w-full h-full p-2 sm:p-4 rounded-md bg-muted shadow-md border">
     <div className="flex flex-col sm:flex-row w-full  gap-1">
  <p className="font-bold w-full sm:w-1/2 text-sm sm:text-base">
   Name:<span className="font-thin ml-2 break-words">{store.name}</span>
  </p>
  <p className="font-bold w-full sm:w-1/2 text-sm sm:text-base">
    Email:<span className="font-thin ml-2 break-words">{store.email}</span>
 </p>
      ...
      <p className="font-bold w-full ">
        Address:<span className="font-thin "> {store.address}</span>
      </p>
      ...
      <div className="flex flex-col sm:flex-row w-full ">  
         <p className="font-bold w-full sm:w-1/2 text-sm sm:text-base">
    Average Rating:<span className="font-thin "> {store.averageRating}</span>
  </p>
  <p className="font-bold w-full sm:w-1/2 text-sm sm:text-base">
    User Rating:<span className="font-thin "> {store.userRating?.value || "NA"}</span>
  </p>
</div>
